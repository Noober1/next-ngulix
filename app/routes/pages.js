class Pages {
	...
	initSpecialPages() {
		this.express.get('/demo/my_special_page/:special_value', (req, res) => {
			const intValue = parseInt(req.params.special_value)
			if(intValue) {
				return this.next.render(req, res, `/demo/special_int`, req.query)
			} else {
				return this.next.render(req, res, `/demo/special_string`, req.query)
			}
		})
	}
