...
export default function Main(props) {
  return <Layout>
    ...
    <p style ={{fontsize:"24px"}}>
      There are two routes defined: "/" and "/demo/my_special_page". There is also a default routing fallback that
    ...
    <h3> Exhibit A </h3>
    <a style={{fontSize: "36px"}} href="/demo/my_special_page/5"> Test special routing + API </a>
    <h3> Exhibit B </h3>
